...
\cvitem{Peer review}{Active reviewer for several journals including Microbial Cell Factories, Frontiers in Microbiology, Photosynthesis Research, and others. The full list of my review contributions is available on \href{https://publons.com/researcher/1192906/michael-jahn/}{\color{darkgray}Publons.org$\nearrow$}.}
\cvitem{Outreach}{All software and computational pipelines available on \href{https://github.com/m-jahn/}{\color{darkgray} github.com$\nearrow$}. Research presented to the public \textit{via} \href{https://m-jahn.github.io/}{\color{darkgray}my home page$\nearrow$}, \href{https://www.researchgate.net/profile/Michael_Jahn}{\color{darkgray}ResearchGate$\nearrow$}, and \href{https://twitter.com/mich_jahn}{\color{darkgray}Twitter$\nearrow$}.}
...
\cvitem{\listitemsymbol}{\textbf{Jahn M}, Crang N, Janasch M, Hober A, Forsström B, Kimler K, Mattausch A, Chen Q, Asplund-Samuelsson J, Hudson EP. \textit{title}. \textit{Protein allocation and utilization in the versatile chemolithoautotroph Cupriavidus necator}, BioRxiv.org, \textbf{2021}. \textit{In revision}.}
