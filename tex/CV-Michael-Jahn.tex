...
\cvitem{}{\textbf{Postdoctoral fellow}, group of Prof Paul Hudson, Science For Life Laboratory, Stockholm. Topic: Systems biology and metabolic engineering of autotrophic bacteria.}
...
\cventry{5/2016--now}{Postdoctoral researcher}{}{System-wide analysis and metabolic engineering of autotrophic bacteria in the group of Prof Paul Hudson, Science For Life Laboratory - Royal Institute of Technology, Stockholm}{}{}
...
\cvitem{Teaching}{\textbf{lecture for course KE2130 'Renewable fuels'}, at KTH Stockholm. Winter semester 2020/2021 and 2021/2022. Topics: Metabolic engineering, whole cell biocatalysis, genome-scale models, flux balance analysis.}
...
\cvitem{PhD council}{Member of the PhD council and the Environmental Board of the Helmholtz Centre for Environmental Research, Leipzig, 2011-2015. Tasks: Improving environmental footprint of the center, providing guidance for starting PhD students, organizing events.}
...
\cvitem{Expertise}{
Explorative analysis und visualization of complex (biological) data, \newline
Creation of pipelines for automated NGS data processing, \newline
Application of clustering and machine learning algorithms, \newline
Next generation sequencing (Illumina) including library preparation, \newline
Mass spectrometry proteomics, \newline
Flow cytometry and cell sorting \newline
Bioreactor cultivation (chemostat, turbidostat), \newline
Standard molecular biology methods and cloning.
}
...
visualizing gene expression with treemaps\newline
...
interactive apps to monitor bioreactor cultivations, visualize
proteomics and gene knockout library data\newline
\link[fluctuator]{https://github.com/m-jahn/fluctuator} -- 
interface to overlay flux data on metabolic maps in R\newline
\link[lattice-tools]{https://github.com/m-jahn/lattice-tools} --
panel functions to extend R lattice\newline
...
pipelines to process NGS knockout library data
}

\cvitem{Metabolic models}{
\textit{Synechocystis} resource allocation model, for \link[GAMS]{https://github.com/m-jahn/cell-economy-model-legacy}, and \link[ported to python]{https://github.com/m-jahn/cell-economy-model}.\newline
%
\link[Genome scale metabolic model (GEM)]{https://github.com/m-jahn/genome-scale-models} for \textit{Cupriavidus necator} a.k.a. \textit{Ralstonia eutropha}.\newline
%
Genome scale \link[resource balance analysis (RBA) model]{https://github.com/m-jahn/genome-scale-models} for \textit{Cupriavidus necator}.
}
...
\cvitem{Model organisms}{Expertise in cultivation and molecular biology of microorganisms (e.g. cyanobacteria, \textit{Cupriavidus necator}, \textit{Pseudomonas putida}, \textit{E.\,coli}, and \textit{S.\,cerevisae})}

\section{Peer review and outreach}
\cvitem{Peer review}{Active reviewer for several journals including Microbial Cell Factories, Frontiers in Microbiology, Photosynthesis Research, and others. The full list of my review contributions is available on \link[Publons]{https://publons.com/researcher/1192906/michael-jahn/} or \link[ORCID]{https://orcid.org/0000-0002-3913-153X}.}
%
\cvitem{Outreach}{All software and computational pipelines available on \link[GitHub]{https://github.com/m-jahn/}. Research communicated to the public \textit{via} \link[home page]{https://m-jahn.github.io/}, \link[ResearchGate]{https://www.researchgate.net/profile/Michael_Jahn}, and \link[Twitter]{https://twitter.com/mich_jahn}.}


\section{Languages}
\cvitem{German}{Native language}
\cvitem{English}{Proficient user, CEF level C1}
\cvitem{Swedish}{Vantage user, CEF level B2}
