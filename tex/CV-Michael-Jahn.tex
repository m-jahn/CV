...
\cvitem{}{\textbf{Post-doctoral fellow}, group of Prof Paul Hudson, Science For Life Laboratory, Stockholm. Topic: Systems biology and metabolic engineering of autotrophic bacteria.}
...
\cventry{5/2016--now}{Post-doctoral researcher}{}{System-wide analysis and metabolic engineering of autotrophic bacteria in the group of Prof Paul Hudson, Science For Life Laboratory - Royal Institute of Technology, Stockholm}{}{}
...
\cvitem{Nov 11, 2019}{\textbf{Investigation of protein resource allocation in the model CO\textsubscript{2} fixing bacterium \textit{Ralstonia eutropha}} (Swedish: Undersökning av proteiners resursfördelning i en modell för CO\textsubscript{2}-fixerande bakterier, \textit{Ralstonia eutropha}). \newline
...
\cvitem{PhD council}{Member of the PhD council and the Environmental Board of the Helmholtz Centre for Environmental Research, Leipzig, 2011-2015. Tasks: providing guidance for starting PhD students, organizing retreats and other student events.}
...
%\cvitem{Sustainability}{Overuse of (fossil) planetary resources and disposal of non-degradable waste into the environment makes the shift towards a sustainable economy mandatory. Synthetic biology can pave the way for a more sustainable circular economy.}

\cvitem{Data science, metabolic modeling}
...
\cvitem{Programming languages}{R (advanced), Python (moderate)}

\cvitem{Authored software}{
\href{https://github.com/m-jahn/SysbioTreemaps}{\color{darkgray}SysbioTreemaps}, \href{https://github.com/m-jahn/ShinyTreemaps}{\color{darkgray}ShinyTreemaps} -- visualizing gene expression with treemaps\newline
\href{https://github.com/m-jahn/lattice-tools}{\color{darkgray}Lattice-tools} -- panel functions to extend R lattice\newline
\href{https://m-jahn.shinyapps.io/ShinyMC/}{\color{darkgray}ShinyMC},
\href{https://m-jahn.shinyapps.io/ShinyProt/}{\color{darkgray}ShinyProt},
\href{https://m-jahn.shinyapps.io/ShinyLib/}{\color{darkgray}ShinyLib} --  interactive apps to monitor bioreactor cultivations, visualize proteomics and gene knockout library data\newline
\href{https://github.com/m-jahn/fluctuator}{\color{darkgray}fluctuator} -- Interface to overlay flux data on metabolic maps in R\newline
\href{https://github.com/m-jahn/TnSeq-pipe}{\color{darkgray}TnSeq-pipe},
\href{https://github.com/m-jahn/rebar}{\color{darkgray}rebar} -- Pipelines to process NGS knockout library data
}

\cvitem{Metabolic models}{
\textit{Synechocystis} resource allocation model, for \href{https://github.com/m-jahn/cell-economy-model-legacy}{\color{darkgray}GAMS}, and \href{https://github.com/m-jahn/cell-economy-model}{\color{darkgray}ported to python}. \newline
%
\href{https://github.com/m-jahn/genome-scale-models}{\color{darkgray}Genome scale metabolic model (GEM)} for \textit{Cupriavidus necator} a.k.a. \textit{Ralstonia eutropha}. \newline
%
Genome scale \href{https://github.com/m-jahn/genome-scale-models}{\color{darkgray}resource balance analysis (RBA) model} for \textit{Cupriavidus necator} a.k.a. \textit{Ralstonia eutropha}
}
...
\cvitem{Model organisms}{Expertise in cultivation and molecular biology of cyanobacteria (e.g. \textit{Synechocystis sp.}), \textit{Cupriavidus necator}, \textit{Pseudomonas putida}, \textit{E.\,coli}}

\section{Peer review and outreach}
\cvitem{Peer review}{Active reviewer for several journals including Microbial Cell Factories, Frontiers in Microbiology, Photosynthesis Research, and others. The full list of my review contributions is available on \href{https://publons.com/researcher/1192906/michael-jahn/}{\color{darkgray}Publons$\nearrow$} or \href{https://orcid.org/0000-0002-3913-153X}{\color{darkgray}ORCID$\nearrow$}}.
\cvitem{Outreach}{All software and computational pipelines available on \href{https://github.com/m-jahn/}{\color{darkgray} Github$\nearrow$}. Research communicated to the public \textit{via} \href{https://m-jahn.github.io/}{\color{darkgray}home page$\nearrow$}, \href{https://www.researchgate.net/profile/Michael_Jahn}{\color{darkgray}ResearchGate$\nearrow$}, and \href{https://twitter.com/mich_jahn}{\color{darkgray}Twitter$\nearrow$}.}
